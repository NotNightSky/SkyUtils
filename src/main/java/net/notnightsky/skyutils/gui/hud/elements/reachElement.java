...
public class reachElement extends AbstractHudElement {
    ...
    private static double getAttackDistance(Entity attacking, Entity receiving) {
        Box bb = receiving.getBoundingBox();
    ...
    @Override public int getWidth() { return client.textRenderer.getWidth(currentDist != null ? currentDist + " blocks" : getPlaceholderText()); }
